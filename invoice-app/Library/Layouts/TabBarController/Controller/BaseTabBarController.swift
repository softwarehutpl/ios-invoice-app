...
class BaseTabBarController: UITabBarController {
    ...
    func setupTabBarController() {
        ...
        let overview = createViewController(vc: resolver.overViewViewController()!,
                                            ...
                                            title: "Overview")
        let invoices = createViewController(vc: resolver.invoiceListController()!,
        ...
        let clients = createViewController(vc: resolver.clientsViewControler(delegate: nil, listState: .none)!,
                                             ...
                                             title: "Clients")
        let profile = createViewController(vc: resolver.clientsViewControler(delegate: nil, listState: .none)!,
                                      image: #imageLiteral(resourceName: "profile"),
                                      title: "Profile")
        viewControllers = [overview, invoices, clients, profile]
    }
}
